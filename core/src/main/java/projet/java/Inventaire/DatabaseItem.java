...
public class DatabaseItem {
    ...
    Item Arme1 = new Item("arme1", arme1, Item.ItemType.ARME, 3, 35);
    Item Arme2 = new Item("arme2", arme2, Item.ItemType.ARME, 2, 35);
    Item Arme3 = new Item("arme3", arme3, Item.ItemType.ARME, 3, 35);
