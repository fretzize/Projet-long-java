...
set CLASSPATH=%APP_HOME%\lib\Projet long java GDX-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" projet.java.lwjgl3.Lwjgl3Launcher %*
